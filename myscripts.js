...
class Sketch {
  ...
  setupCanvas() {
    ...
    this.renderer.domElement.style.width = '350px';
    this.renderer.domElement.style.height = '400px';
...
var folderDisplay = document.getElementById("folder")

var btn2 = document.getElementById("myBtn2");

btn2.onclick = function() {
  console.log('folderDisplay', folderDisplay);
  if (folderDisplay.style.display === "block") {
...
console.log('project1Modal', project1Modal);
var project1 = document.getElementById("project1");

project1.onclick = function() {
  if (project1Modal.style.display === "block") {
...
// When the user clicks anywhere outside of the project1Modal, close it
window.onclick = function(event) {
...
console.log('project2Modal', project2Modal);
var project2 = document.getElementById("project2");

project2.onclick = function() {
  if (project2Modal.style.display === "block") {
...
console.log('project3Modal', project3Modal);
var project3 = document.getElementById("project3");

project3.onclick = function() {
  if (project3Modal.style.display === "block") {
...
var span2 = document.getElementsByClassName("closeIt3")[0];
